...
###	PostgreSQL
*PostgreSQL* es una base de datos relacional *OpenSource*. Siendo también la base de datos más popular actualmente, por sobre MySQL o SQLite, según la [Developer Survey](https://survey.stackoverflow.co/2023/#section-most-popular-technologies-databases) de Stack Overflow.  Al ser una base de datos OpenSource tan popular y contar con muchos años de existencia, posee un amplio apoyo por parte de la comunidad. Reflejado en distintos proyectos que buscan poder implementar esta base de datos junto a distintos stacks tecnológicos. Por ejemplo, [Sequelize](https://sequelize.org/) como ORM (*Object Relational Mapping*) es compatible con PostgreSQL. Un ORM nos permite abstraer la lógica de negocio en nuestro proyecto, para que luego este se comunique con la base de datos para poder reflejar los cambios. 
